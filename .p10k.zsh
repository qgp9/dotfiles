# Generated by Powerlevel10k configuration wizard on 2024-07-09 at 08:42 EEST.
...
() {
  ...
  #BS typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='❯'
  ...
  #BS typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=always
